...
import { FileText, TrendingUp, Users, Download, BarChart3, PieChart, Activity, Calendar } from "lucide-react"
import {
  LineChart,
  Line,
  XAxis,
...
export function AttendanceReports({ students, attendance }: AttendanceReportsProps) {
  ...
  return (
    <div className="space-y-6">
      <div>
        <h1 className="text-3xl font-bold text-balance">Attendance Reports</h1>
        <p className="text-muted-foreground text-pretty">
          Comprehensive attendance analytics and insights for better decision making.
        </p>
      </div>
            ...
            <Card>
              ...
              <CardContent>
                <div className="space-y-4">
                  ...
                  <div className="flex items-center justify-between p-3 border rounded-lg">
                    <span className="font-medium">Average Daily Attendance</span>
                    <Badge variant="outline">
                      {dailyTrend.length > 0
                        ? Math.round(dailyTrend.reduce((sum, day) => sum + day.attendanceRate, 0) / dailyTrend.length)
                        : 0}
                      %
                    </Badge>
                  </div>
        ...
        <TabsContent value="breakdown" className="space-y-6">
              ...
              <CardContent>
                <ResponsiveContainer width="100%" height={300}>
                  <BarChart data={classStats}>
                    ...
                    <YAxis />
                    <Tooltip />
                    <Bar dataKey="attendanceRate" fill="#0891b2" name="Attendance Rate (%)" />
                  </BarChart>
                </ResponsiveContainer>
              </CardContent>
            </Card>
          ...
          <Card>
            <CardHeader>
              ...
              <CardDescription>Complete breakdown by class and department</CardDescription>
            </CardHeader>
            <CardContent>
              <Table>
                <TableHeader>
